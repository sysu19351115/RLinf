...
- [2026/05] 🔥 RLinf 通过系统级优化（功能瘦身、按需观测、混合切分流水线并行），为 BEHAVIOR 仿真器实现端到端 **25 倍** 加速，将 rollout 延迟从 1028.7 ms/step 降至 41.2 ms/step。博客：[BEHAVIOR 系统优化](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/blog/behavior_system_optimization.html)
